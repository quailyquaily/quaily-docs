...
- 若读者购买了一篇价格为 1000 日元的文章，Quaily 将向读者收取 100 日元的消费税，实际支付金额为 1100 日元。
...
每笔订单，Quaily 会收取平台服务费：

- Quaily 托管支付：按交易金额收取 10%
- 作者自行托管支付：按订单金额（不含 VAT）收取 10%，在每笔订单完成时从作者点数中扣除

作者自行托管支付请保持足够点数，点数余额可在 [Profile - Credits](https://quaily.com/dashboard/profile/credits) 管理。

## 基于 Credits 的功能计费

Quaily 还会对部分创作者高级功能按点数计费：

- 额外发送配额：100 Credits / 次
- 手动添加订阅者：20 Credits / 人
- 从互联网导入文章：10 Credits / 篇

点数属于预付费余额。VAT 在充值时收取，点数消费时不再额外加收 VAT。
