...
在作者自行托管的支付模式下，Quaily 会在每笔订单完成时，从作者的 **Credits（点数）** 中扣除平台费。

- 费率：订单金额（不含 VAT）的 10%
- 点数余额可在 [Profile - Credits](https://quaily.com/dashboard/profile/credits) 管理
...
部分高级功能按 Credits（点数）按次扣费：

- 额外发送配额：100 Credits / 次
- 手动添加订阅者：20 Credits / 人
- 从互联网导入文章：10 Credits / 篇

这些功能此前属于 Quaily Plus 权益，现已改为按点数直接扣费。
